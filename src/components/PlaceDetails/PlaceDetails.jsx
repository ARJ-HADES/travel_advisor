             ...
             <CardContent>
                ...
                {place?.awards?.map((award)=>(
                  <Box my={1} display="flex" justifyContent="space-between" alignItem="center">
                      ...
                      <Typography variant="subtitle2" color="testsecondary">{award.display_name}</Typography>
                  </Box>
                ))}
                ...
                {place?.address &&(
                 ...
                 {place?.phone &&(
                  <Typography gutterBottom variant="subtitle2" justifyContent="space-between" color="textsecondary" classname={classes.spacing}>
